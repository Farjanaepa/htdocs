...
<html lang="en" dir="ltr">
  <head>
    <meta charset="utf-8">
    <title>POS-By Tetra_link</title>
    <link rel="stylesheet" href="bootstrap/css/bootstrap.min.css">
		<script src="bootstrap/js/jquery.min.js"></script>
		<script src="bootstrap/js/bootstrap.min.js"></script>
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.3.1/css/all.css" integrity="sha384-mzrmE5qonljUremFsqc01SB46JvROS7bZs3IO2EmfFsd15uHvIt+Y8vEf7N7fWAU" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <link rel="shortcut icon" href="images/tetra-link.jpeg" type="image/x-icon">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="row col col-xs-8 col-sm-8 col-md-8 col-lg-8">
            ...
            <?php
              ...
              createSection1('manage_medicine.php', 'Total Product', 'medicines');
              ...
              <table class="table table-bordered table-striped table-hover">
                <tbody>
                  ...
                  <tr>
                    ...
                    ?>
                    <th>Total Sales</th>
                    <th class="text-success">Tk. <?php echo $total; ?></th>
                  </tr>
                  <tr>
                    <?php
                      //echo $date;
                    ...
                    <th class="text-danger">Tk. <?php echo $total; ?></th>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <div class="row">
          ...
          <?php
            ...
            createSection2('shopping-bag', 'add_medicine.php', 'Add New Product');
